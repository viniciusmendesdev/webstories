    ...
    <div class="height-100 bg-light">
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control cadastro" id="titulo" value="<?=$resQuiz['nome']?>">
            </div>

            <div class="form-group">
                <label for="">Digite uma url de destino:</label>
                <input type="text" class="form-control cadastro" id="urlDestino" value="<?=$resQuiz['urlDestino']?>">
            </div>

            <div class="form-group">
                <label for="">Digite uma frase para o formulário final:</label>
                <input type="text" class="form-control cadastro" id="frasefinal" value="<?=$resQuiz['frasefinal']?>">
            </div>

            <hr>
            <input type="hidden" value="<?=$idUser?>" id="idUser">
            <input type="hidden" value="<?=$resQuiz['id']?>" id="idQuiz">
