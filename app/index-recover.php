	...
	<div class="container">
		...
		<div class="row">
			...
			<hr>
                ...
                <input type="hidden" id="acao" value="recuperar">

				<div class="form-group">
                    <a href="#" id="enviar" class="btn btn-primary">Recuperar senha</a>
				</div>

                <div class="form-group">
                    <a href="index.php" id="enviar" class="btn btn-success">Fazer Login</a>
				</div>
